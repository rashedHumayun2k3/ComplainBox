...
using KeyNotFoundException = CB.Api.Exceptions.KeyNotFoundException;
using NotImplementedException = CB.Api.Exceptions.NotImplementedException;
using UnauthorizedAccessException = CB.Api.Exceptions.UnauthorizedAccessException;

namespace CB.Api.CustomMiddlewares
{
